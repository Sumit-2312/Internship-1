...
const InstagramLogin = () => {
  const handleLogin = () => {
    ...
    const authUrl = `https://www.instagram.com/oauth/authorize?enable_fb_login=0&force_authentication=1&client_id=9583293718417663&redirect_uri=https://instagram-h8yy.onrender.com/accessToken&response_type=code&scope=instagram_business_basic%2Cinstagram_business_manage_messages%2Cinstagram_business_manage_comments%2Cinstagram_business_content_publish%2Cinstagram_business_manage_insights`;
